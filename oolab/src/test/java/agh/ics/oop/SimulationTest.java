...
class SimulationTest {
    ...
    void upperBound(){
        ...
        assertEquals(new Vector2d(2, 4), simulation.getAnimals().get(1).getPosition());
    ...
    void rightBound(){
        ...
        assertEquals(new Vector2d(4, 2), simulation.getAnimals().get(2).getPosition());
    }
    ...
    void leftBound(){
        ...
        assertEquals(new Vector2d(0, 2), simulation.getAnimals().get(0).getPosition());
    ...
    void lowerBound(){
        ...
        assertEquals(new Vector2d(2, 0), simulation.getAnimals().get(0).getPosition());
        assertEquals(new Vector2d(2, 0), simulation.getAnimals().get(1).getPosition());
